...
lblTitle = Label(Tops,font=('arial',50,'bold'),text="Advanced Tic Tac Toe Game",bd=21,bg='CadetBlue',fg='Cornsilk',justify=CENTER)
...
lblPlayerX = Label(RightFrame1,font=('arial',40,'bold'),text="Player X :",bg='CadetBlue',padx=2,pady=2)
...
lblPlayerO = Label(RightFrame1,font=('arial',40,'bold'),text="Player O :",bg='CadetBlue',padx=2,pady=2)
